/*
Разработать процедуру вывода справки о командах MS DOS с возможностью
перенаправления справочной информации в файл. Организовать ввод имени
интересуемой команды, пути и имени результирующего файла в процедуру
параметров командной строки при вызове процедуры.
*/

//cscript 1.js {command} {path} {filename}
